document.addEventListener("DOMContentLoaded", function () {
    ...
    const helper = [
        { name: "Nexo", title: "Certified Gangsta", image: "https://cdn.discordapp.com/avatars/459630314805788682/b117f010596101d9891266bcc0e013a1?size=1024", url: "https://www.bubba.industries/frank" },
        { name: "Rob", title: "Pookie", image: "https://cdn.discordapp.com/avatars/554939145626058767/e97967877e488587e8bcd588a444dc10?size=1024", url: "https://www.bubba.industries/rob" }
    ];
    const supporters = [
    ...
    const helperContainer = document.getElementById("helper-list");
    ...
    helper.forEach(helper => {
        helperContainer.appendChild(createMemberCard(helper));
    });
